            ...
            {userAuth.isAnonymous && (
              <div className="rounded-2xl border border-indigo-900/40 bg-indigo-950/20 p-4 space-y-3">
                ...
                <p className="text-zinc-400 text-[11px] leading-relaxed">
                  You are currently using an <strong>Anonymous Guest session</strong>. Sign in with Google to preserve all your daily tasks, study journal, and custom settings across all mobile, tablet, and desktop devices!
                </p>
                <button
